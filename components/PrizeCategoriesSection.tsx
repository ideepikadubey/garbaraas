...
export default function PrizeCategoriesSection() {
  return (
    <section id="prizes" className="relative py-10 md:py-16 bg-white border-b border-amber-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-8 sm:mb-10">
          ...
          <div className="mt-4 sm:mt-5 inline-flex items-center justify-center gap-1.5 sm:gap-2 px-3.5 sm:px-5 py-2 sm:py-2.5 rounded-2xl sm:rounded-full bg-amber-50 border-2 border-amber-300 text-amber-950 text-[10px] min-[360px]:text-xs sm:text-sm font-extrabold shadow-sm text-center max-w-full">
            <Calendar className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-amber-600 flex-shrink-0" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 max-w-6xl mx-auto">
          ...
          {/* KIDS CATEGORY (5 cols) - Golden Yellow Theme */}
          <div className="lg:col-span-5 rounded-3xl bg-white border-2 border-amber-300 p-6 sm:p-8 flex flex-col justify-between shadow-sm hover:shadow-md transition">
            <div>
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-gradient-to-r from-amber-500 via-yellow-400 to-amber-500 text-stone-950 mb-3 shadow-sm ring-1 ring-amber-300">
              ...
              <p className="text-xs text-amber-800 font-semibold mb-6">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-4 p-4 rounded-2xl bg-amber-50/70 border border-amber-200 hover:border-amber-400 transition">
                  <div className="w-12 h-12 rounded-xl bg-amber-100 border border-amber-300 flex items-center justify-center flex-shrink-0 text-amber-800 shadow-sm">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-amber-800 font-bold">Grand Junior Championship Trophy</p>
                    <p className="text-[11px] text-stone-600 mt-1 font-medium">Evaluated on rhythm, smile, steps coordination, and grace.</p>
                  </div>
                </div>

                {/* Award 2 */}
                <div className="flex items-start gap-4 p-4 rounded-2xl bg-yellow-50/70 border border-yellow-200 hover:border-yellow-400 transition">
                  <div className="w-12 h-12 rounded-xl bg-yellow-100 border border-yellow-300 flex items-center justify-center flex-shrink-0 text-amber-800 shadow-sm">
            ...
            <div className="mt-8 pt-4 border-t border-stone-200 text-center">
              <span className="text-xs text-amber-900 font-bold">Special Certificates & Gifts for All Kids</span>
            </div>
          </div>

          {/* ADULTS CATEGORY (7 cols) - Royal Jamuni Purple & Gold Theme */}
          <div className="lg:col-span-7 rounded-3xl bg-white border-2 border-garba-purple-300 p-6 sm:p-8 flex flex-col justify-between shadow-sm hover:shadow-md transition">
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                {/* Award 3 */}
                <div className="p-4 rounded-2xl bg-yellow-50/70 border border-yellow-200 hover:border-yellow-400 transition">
                  <div className="flex items-center gap-2 text-amber-800 mb-2">
                ...
                {/* Award 5 (Span full) */}
                <div className="sm:col-span-2 p-4 rounded-2xl bg-amber-50/70 border border-amber-200 hover:border-amber-400 transition flex items-center gap-4">
