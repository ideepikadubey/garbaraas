...
export default function PricingSection({ onSelectCategory }: PricingSectionProps) {
  return (
    <section id="pricing" className="relative py-10 md:py-16 bg-white border-b border-amber-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-12 max-w-3xl mx-auto rounded-3xl bg-gradient-to-r from-amber-50/90 via-yellow-50/60 to-amber-50/90 border-2 border-amber-300 p-6 sm:p-7 text-center shadow-md relative overflow-hidden">
          <div className="inline-flex items-center gap-2 text-amber-900 font-serif font-bold text-xs sm:text-sm tracking-widest uppercase mb-1">
          ...
          <div className="mt-3 inline-block px-4 py-1.5 rounded-full bg-white border border-amber-300 text-xs font-mono font-bold text-amber-950 shadow-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
          ...
          {/* Card 1: Female (Golden Amber Theme) */}
          <div className="relative rounded-3xl bg-white border-2 border-amber-300 p-6 sm:p-7 flex flex-col justify-between hover:border-amber-500 hover:shadow-md transition-all duration-300 group">
            <div>
              <div className="text-xs uppercase font-extrabold tracking-widest text-amber-800 mb-1">
                Category A • Flagship
              </div>
              <h3 className="text-2xl font-serif font-bold text-maroon-950 group-hover:text-amber-700 transition">
                Female Admission
              </h3>
              ...
              <div className="my-6 pb-4 border-b border-stone-200">
                <div className="flex items-baseline gap-1">
                  <span className="text-4xl sm:text-5xl font-serif font-black text-amber-600">₹2500</span>
              ...
              <ul className="space-y-3 text-xs sm:text-sm text-stone-800 font-medium mb-6">
            ...
            <button
              ...
              className="w-full py-3 px-4 rounded-xl bg-gradient-to-r from-amber-500 via-yellow-400 to-amber-500 text-stone-950 font-black text-sm ring-1 ring-amber-300 hover:brightness-105 transition shadow-sm cursor-pointer"
            >
          ...
          <div className="relative rounded-3xl bg-white border-2 border-garba-orange-400 p-6 sm:p-7 flex flex-col justify-between shadow-lg transition-all duration-300 transform md:-translate-y-2 group">
            ...
            {/* Best Value Badge */}
            <div className="absolute -top-3.5 left-1/2 -translate-x-1/2 px-4 py-1 rounded-full bg-gradient-to-r from-amber-500 via-garba-orange-500 to-yellow-400 text-stone-950 font-black text-xs uppercase tracking-widest shadow-md flex items-center gap-1">
            ...
            <div className="space-y-2">
              ...
              <button
                ...
                className="w-full py-2 px-3 rounded-lg bg-amber-50 border border-amber-300 text-amber-950 font-bold text-xs hover:bg-amber-100 transition cursor-pointer"
              >
